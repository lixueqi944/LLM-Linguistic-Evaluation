...
|---|---|---|---|---|
| DN-01 | It was not impossible for Mr Kinnock to form an ad... | 肯定 | A | ✓ |
| DN-02 | With an empire of such a size, it was a difficult ... | 肯定 | A | ✓ |
| DN-03 | And to the normal layman (pause) that sounds bette... | 比什么都不说好 | A | ✓ |
| DN-04 | At the Clothes Exchange, dear, you don’t need no m... | 不需要钱 | B | ✓ |
| DN-05 | We don’t need no education.... | 否定 | A | ✗ |
| DN-06 | Nor did you nothing hear?... | 否定 | B | ✓ |
...
A | ✓ |
| DG-03 | Later, a friend of Hilton’s called and collected t... | 可以; 强调friend这个新信息 | A
B | ✓ |
...
A | ✗ |
| DG-07 | My mother’s picture shows only a drab, mouse-like ... | 主体（以母亲为主题的照片）; 不可以 | D
A | ✗ |
